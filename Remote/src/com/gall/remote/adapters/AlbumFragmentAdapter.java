 ...
 *
 */
public class AlbumFragmentAdapter extends ArrayAdapter<SongFile> {
	private Context c;

	//Constructor
	public AlbumFragmentAdapter(Context c, int resourceID, List<SongFile> items){
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		holder.titleTxt.setText(sf.getAlbum());
